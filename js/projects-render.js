(function () {
  ...
  var ICONS = {
    ...
    store: {
      vb: "0 0 24 24",
      rule: true,
      d: "M12 1a5 5 0 0 0-5 5v1H3.4l1.1 14.2A2 2 0 0 0 6.5 23h11a2 2 0 0 0 2-1.8L20.6 7H17V6a5 5 0 0 0-5-5zm0 2a3 3 0 0 1 3 3v1H9V6a3 3 0 0 1 3-3z"
    },
    play: {
      vb: "0 0 24 24",
      rule: true,
      d: "M2 4h20a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1zm8 4.2v7.6l6.5-3.8L10 8.2z"
    },
    download: {
      vb: "0 0 24 24",
  ...
  function iconFor(l) {
    ...
    if (/apps\.apple\.com/.test(href) || /appstore|app store/.test(label)) return "store";
    ...
    if (/play on browser|play in browser/.test(label)) return "play";
    ...
    if (/website|deployed/.test(label)) return "globe";
    return "link";
  }
